...
import 'package:xl_zhihu_flutter/main/SearchRoute.dart';

class MyRoute extends StatefulWidget {
  createState() => new MyRouteState();
}
                  ...
                  child: new Column(
                    children: <Widget>[
                      ...
                      new Container(
                        child: new Text("社区建设",
                            style: new TextStyle(
                                color: ColorRoute.fontColor, fontSize: 14.0)),
                      )
                    ],
                  ),
                )),
                ...
                child: new Container(
                  child: new Column(
                    children: <Widget>[
                      ...
                      new Container(
                        child: new Text(
                            ColorRoute.dark == true ? "日间模式" : "夜间模式",
                            style: new TextStyle(
                                color: ColorRoute.fontColor, fontSize: 14.0)),
                      )
                    ],
                ...
                child: new Row(
                  children: <Widget>[
                    ...
                    new Container(
                      child: new FlatButton(
                          onPressed: (){},
                          child: new Text("拍一个", style: new TextStyle(color: Colors.white),)
                      ),
                    )
                  ],
                )
              ...
              child: new Row(
                children: <Widget>[
                  ...
                  new Container(
                    child: new FlatButton(
                        onPressed: (){},
                        child: new Text("去往想法首页", style: new TextStyle(color: Colors.white),)
                    ),
                  )
                ],
              ),
                            ...
                            child: new Column(
                              children: <Widget>[
                                new Align(
                                  ...
                                  child: new Container(
                                    child: new Text("苹果 WWDC 2018 正在举行", style: new TextStyle(color: ColorRoute.dark == true? Colors.white70 : Colors.black, fontSize: 16.0),),
                                  ),
                                ),
                                new Align(
                                  alignment: Alignment.centerLeft,
                                  child: new Container(
                                    ...
                                    child: new Text("软件更新意料之中，硬件之谜...", style: new TextStyle(color: ColorRoute.fontColor),),
                                  ),
                                )
                              ],
                            ),
                              ...
                              child: new Column(
                                children: <Widget>[
                                  new Align(
                                    alignment: Alignment.centerLeft,
                                    child: new Container(
                                      child: new Text("此刻你的桌子是什么样子？", style: new TextStyle(color: ColorRoute.dark == true? Colors.white70 : Colors.black, fontSize: 16.0),),
                                    ),
                                  ),
                                  new Align(
                                      alignment: Alignment.centerLeft,
                                      child: new Container(
                                        margin: const EdgeInsets.only(top: 6.0),
                                        child: new Text("晒一晒你的书桌/办公桌", style: new TextStyle(color: ColorRoute.fontColor),),
                                      )
                                  )
                              ...
                              child: new Column(
                                children: <Widget>[
                                  new Align(
                                    alignment: Alignment.centerLeft,
                                    child: new Container(
                                      child: new Text("关于高考你印象最深的是...", style: new TextStyle(color: ColorRoute.dark == true? Colors.white70 : Colors.black, fontSize: 16.0),),
                                    ),
                                  ),
                                  new Align(
                                      alignment: Alignment.centerLeft,
                                      child: new Container(
                                        margin: const EdgeInsets.only(top: 6.0),
                                        child: new Text("聊聊你的高三生活", style: new TextStyle(color: ColorRoute.fontColor),),
                                      )
                                  )
                              ...
                              child: new Column(
                                children: <Widget>[
                                  new Align(
                                    alignment: Alignment.centerLeft,
                                    child: new Container(
                                      child: new Text("夏天一定要吃的食物有哪些", style: new TextStyle(color: ColorRoute.dark == true? Colors.white70 : Colors.black, fontSize: 16.0),),
                                    ),
                                  ),
                                  new Align(
                                      alignment: Alignment.centerLeft,
                                      child: new Container(
                                        margin: const EdgeInsets.only(top: 6.0),
                                        child: new Text("最适合夏天吃的那种", style: new TextStyle(color: ColorRoute.fontColor),),
                                      )
                                  )
